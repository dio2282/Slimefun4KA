    ...
    public void openScript(Player p, SlimefunUniversalBlockData uniData, String sourceCode) {
        ...
        menu.addItem(
                ...
                new CustomItemStack(
                        ...
                        "",
                        "&7\u21E8 &eLeft-Click &7Return to android control panel"));
            ...
            if (i == script.length - 1) {
                ...
                menu.addItem(
                        ...
                        new CustomItemStack(
                                ...
                                "",
                                "&7\u21E8 &eLeft-Click &7Edit",
                                "&7\u21E8 &eRight-Click &7Delete",
                                "&7\u21E8 &eShift + Right-Click &7Copy"));
                menu.addMenuClickHandler(i, (pl, slot, item, action) -> {
    ...
    public void openScriptEditor(Player p, SlimefunUniversalBlockData uniData) {
        ...
        menu.addItem(
                ...
                new CustomItemStack(
                        ...
                        "&6> Download script",
                        "",
                        "&eDownload scripts uploaded by other players from the server",
                        "&eCan be used immediately or modified before use"));
