...
public final class SlimefunItems {
    ...
    public static final SlimefunItemStack PORTABLE_DUSTBIN = new SlimefunItemStack(
            "PORTABLE_DUSTBIN", HeadTexture.TRASH_CAN, "&6Portable Dustbin", "&rEasily dispose of excess items", "", LoreBuilder.RIGHT_CLICK_TO_OPEN);
    ...
    public static final SlimefunItemStack INFERNAL_BONEMEAL =
            new SlimefunItemStack("INFERNAL_BONEMEAL", Material.BONE_MEAL, "&4Infernal Bonemeal", "", "&cAccelerates the growth speed of nether wart");
    ...
    public static final SlimefunItemStack GOLD_PAN =
            new SlimefunItemStack("GOLD_PAN", Material.BOWL, "&6Gold Pan", "&a&oCan obtain various ores", "", "&7&eRight-Click&7 to pan for gold from gravel");
    public static final SlimefunItemStack NETHER_GOLD_PAN =
            new SlimefunItemStack("NETHER_GOLD_PAN", Material.BOWL, "&4Nether Gold Pan", "", "&7&eRight-Click&7 to pan for gold from soul sand");
    ...
    public static final SlimefunItemStack SOLAR_HELMET =
            new SlimefunItemStack("SOLAR_HELMET", Material.IRON_HELMET, "&bSolar Helmet", "", "&a&oCharges items and equipment you're holding");
    ...
    public static final SlimefunItemStack REINFORCED_CLOTH = new SlimefunItemStack(
            "REINFORCED_CLOTH", Material.PAPER, "&bReinforced Cloth", "", "&fThis cloth has been reinforced with lead", "&fand can prevent negative effects from radiation");
    ...
    public static final SlimefunItemStack NIGHT_VISION_GOGGLES = new SlimefunItemStack(
            "NIGHT_VISION_GOGGLES", Material.LEATHER_HELMET, Color.BLACK, "&aNight Vision Goggles", "", "&9+ Night Vision effect");
    public static final SlimefunItemStack ELYTRA_CAP = new SlimefunItemStack(
            "ELYTRA_CAP", Material.LEATHER_HELMET, Color.PURPLE, "&5Elytra Cap", "", "&7Allows you to fly with elytra", "&7without falling and becoming a pancake");
    public static final SlimefunItemStack FARMER_SHOES =
            new SlimefunItemStack("FARMER_SHOES", Material.LEATHER_BOOTS, Color.YELLOW, "&eFarmer's Boots", "", "&6&oPrevents you from trampling crops");
    ...
    public static final SlimefunItemStack SPLINT = new SlimefunItemStack(
            "SPLINT", Material.STICK, "&cSplint", "", "&aLevel 1 Medical Supply", "", "&rRestores 2 health", "", LoreBuilder.RIGHT_CLICK_TO_USE);
    ...
    public static final SlimefunItemStack MAGICAL_ZOMBIE_PILLS =
            new SlimefunItemStack("MAGICAL_ZOMBIE_PILLS", Material.NETHER_WART, "&6Magical Zombie Pills", "", "&eRight-Click to instantly cure &7zombie villagers/piglins");

    public static final SlimefunItemStack FLASK_OF_KNOWLEDGE = new SlimefunItemStack(
            "FLASK_OF_KNOWLEDGE", Material.GLASS_BOTTLE, "&cFlask of Knowledge", "", "&rAllows you to store experience in a bottle", "&7Requires &a1 level");
    ...
    public static final SlimefunItemStack FORTUNE_COOKIE =
            new SlimefunItemStack("FORTUNE_COOKIE", Material.COOKIE, "&6Fortune Cookie", "", "&a&oTells you what will happen in the future :o");
    ...
    public static final SlimefunItemStack MONSTER_JERKY =
            new SlimefunItemStack("MONSTER_JERKY", Material.ROTTEN_FLESH, "&6Monster Jerky", "", "&a&oRefreshing and hunger-resistant");
    ...
    public static final SlimefunItemStack EASTER_EGG = new SlimefunItemStack(
            "EASTER_EGG", HeadTexture.EASTER_EGG, "&rEaster Egg", "&dHappy Easter! Open the gift to see.", "", LoreBuilder.RIGHT_CLICK_TO_OPEN);
    ...
    public static final SlimefunItemStack SWORD_OF_BEHEADING = new SlimefunItemStack(
            "SWORD_OF_BEHEADING", Material.IRON_SWORD, "&6Sword of Beheading", "&7Beheading II", "", "&rHas a chance to behead creatures", "&r(Increases chance of dropping Wither Skeleton Skulls)");
    public static final SlimefunItemStack BLADE_OF_VAMPIRES = new SlimefunItemStack(
            "BLADE_OF_VAMPIRES", Material.GOLDEN_SWORD, "&cBlade of Vampires", "&7Life Steal I", "", "&rHas a 45% chance when attacking", "to restore 2 health to yourself");
    public static final SlimefunItemStack SEISMIC_AXE = new SlimefunItemStack(
            "SEISMIC_AXE", Material.IRON_AXE, "&aSeismic Axe", "", "&7&oCreates an earthquake...", "", LoreBuilder.RIGHT_CLICK_TO_USE);
    ...
    public static final SlimefunItemStack EXPLOSIVE_BOW =
            new SlimefunItemStack("EXPLOSIVE_BOW", Material.BOW, "&cExplosive Bow", "&rArrows shot from this bow will launch targets into the air");
    public static final SlimefunItemStack ICY_BOW =
            new SlimefunItemStack("ICY_BOW", Material.BOW, "&bIcy Bow", "&rArrows shot from this bow", "&rwill freeze targets, preventing movement (for 2 seconds)");

    /*		 Tools		*/
    public static final SlimefunItemStack SMELTERS_PICKAXE =
            new SlimefunItemStack("SMELTERS_PICKAXE", Material.DIAMOND_PICKAXE, "&6Smelter's Pickaxe", "&c&lAuto-Smelting", "", "&9Has Fortune effect when mining");
    ...
    public static final SlimefunItemStack PICKAXE_OF_CONTAINMENT =
            new SlimefunItemStack("PICKAXE_OF_CONTAINMENT", Material.IRON_PICKAXE, "&cPickaxe of Containment", "", "&9Can obtain spawners");
    public static final SlimefunItemStack EXPLOSIVE_PICKAXE = new SlimefunItemStack(
            "EXPLOSIVE_PICKAXE", Material.DIAMOND_PICKAXE, "&eExplosive Pickaxe", "", "&rMines ores quickly with explosions", "", "&9Supports Fortune enchantment");
    public static final SlimefunItemStack EXPLOSIVE_SHOVEL =
            new SlimefunItemStack("EXPLOSIVE_SHOVEL", Material.DIAMOND_SHOVEL, "&eExplosive Shovel", "", "&rAllows you to dig many blocks at once");
    ...
    public static final SlimefunItemStack PICKAXE_OF_VEIN_MINING = new SlimefunItemStack(
            "PICKAXE_OF_VEIN_MINING", Material.DIAMOND_PICKAXE, "&ePickaxe of Vein Mining", "", "&rThis pickaxe will mine", "&rentire ore veins...");
    public static final SlimefunItemStack CLIMBING_PICK = new SlimefunItemStack(
            "CLIMBING_PICK", Material.IRON_PICKAXE, "&bClimbing Pick", "", "&fAllows you to right-click", "&fto climb on specified surfaces.", "&fEnchanting with Efficiency will increase climbing speed");
    ...
    public static final SlimefunItemStack GLOWSTONE_HELMET = new SlimefunItemStack(
            "GLOWSTONE_HELMET", Material.LEATHER_HELMET, Color.YELLOW, "&e&lGlowstone Helmet", "", "&a&oShines like the sun!", "", "&9+ Night Vision effect");
    ...
    public static final SlimefunItemStack GLOWSTONE_BOOTS = new SlimefunItemStack(
            "GLOWSTONE_BOOTS", Material.LEATHER_BOOTS, Color.YELLOW, "&e&lGlowstone Boots", "", "&a&oShines like the sun!", "", "&9+ Night Vision effect");
    public static final SlimefunItemStack RAINBOW_LEATHER =
            new SlimefunItemStack("RAINBOW_LEATHER", Material.RABBIT_HIDE, Color.FUCHSIA, "&dRainbow Leather", "", "&fUsed to craft rainbow equipment");
    ...
    public static final SlimefunItemStack ENDER_HELMET = new SlimefunItemStack(
            "ENDER_HELMET", Material.LEATHER_HELMET, Color.fromRGB(28, 25, 112), "&5&lEnder Helmet", "", "&a&oFree Movement");
    public static final SlimefunItemStack ENDER_CHESTPLATE = new SlimefunItemStack(
            "ENDER_CHESTPLATE", Material.LEATHER_CHESTPLATE, Color.fromRGB(28, 25, 112), "&5&lEnder Chestplate", "", "&a&oFree Movement");
    public static final SlimefunItemStack ENDER_LEGGINGS = new SlimefunItemStack(
            "ENDER_LEGGINGS", Material.LEATHER_LEGGINGS, Color.fromRGB(28, 25, 112), "&5&lEnder Leggings", "", "&a&oFree Movement");
    ...
    public static final SlimefunItemStack HAZMAT_CHESTPLATE = new SlimefunItemStack(
            "HAZMAT_CHESTPLATE", Material.LEATHER_CHESTPLATE, Color.ORANGE, "&cHazmat Suit", "", "&7Allows you to walk in fire and lava");
    ...
    public static final SlimefunItemStack BEE_WINGS = new SlimefunItemStack(
            "BEE_WINGS", Material.ELYTRA, "&e&lBee Wings", " ", "&fBuzz buzz", " ", "&9When near the ground", "&9slow fall mode will activate", " ");
    ...
    public static final SlimefunItemStack MAGICAL_GLASS =
            new SlimefunItemStack("MAGICAL_GLASS", Material.GLASS_PANE, "&6Magical Glass", "", "&a&oUsed by various magical items");
    public static final SlimefunItemStack SYNTHETIC_SHULKER_SHELL = new SlimefunItemStack(
            "SYNTHETIC_SHULKER_SHELL", Material.SHULKER_SHELL, "&dSynthetic Shulker Shell", "", "&fCan be used in crafting table", "&fjust like regular shulker shells");
    ...
    public static final SlimefunItemStack DUCT_TAPE =
            new SlimefunItemStack("DUCT_TAPE", HeadTexture.DUCT_TAPE, "&8Duct Tape", "", "&rCan be used in the Auto-Anvil", "&rto repair items");
    ...
    public static final SlimefunItemStack STRANGE_NETHER_GOO = new SlimefunItemStack(
            "STRANGE_NETHER_GOO", Material.PURPLE_DYE, "&5Strange Nether Goo", "", "&fA strange substance", "&fCan be obtained by trading with Piglins");
    ...
    public static final SlimefunItemStack CARGO_MOTOR =
            new SlimefunItemStack("CARGO_MOTOR", HeadTexture.CARGO_MOTOR, "&3Cargo Motor", "", "&7Important component for cargo network related machines");
    ...
    public static final SlimefunItemStack ANCIENT_ALTAR = new SlimefunItemStack(
            "ANCIENT_ALTAR", Material.ENCHANTING_TABLE, "&dAncient Altar", "", "&5Build an altar in the world", "&5and craft items using ancient rituals");
    ...
    public static final SlimefunItemStack CRAFTING_MOTOR =
            new SlimefunItemStack("CRAFTING_MOTOR", HeadTexture.CRAFTING_MOTOR, "&6Crafting Motor", "", "&7Important component for auto-crafters");
    ...
    public static final SlimefunItemStack TALISMAN_MINER = new SlimefunItemStack(
            "MINER_TALISMAN", Material.EMERALD, "&aMiner Talisman", "", "&fWhen this talisman is in your inventory", "&fyou have a 20% chance to double", "&fthe ores you mine");
    public static final SlimefunItemStack TALISMAN_FARMER = new SlimefunItemStack(
            "FARMER_TALISMAN", Material.EMERALD, "&aFarmer Talisman", "", "&fWhen this talisman is in your inventory", "&fyou have a 20% chance to double", "&fthe crops you harvest");
    public static final SlimefunItemStack TALISMAN_HUNTER = new SlimefunItemStack(
            "HUNTER_TALISMAN", Material.EMERALD, "&aHunter Talisman", "", "&fWhen this talisman is in your inventory", "&fyou have a 20% chance to double", "&fthe drops from mobs you kill");
    ...
    public static final SlimefunItemStack TALISMAN_ANGEL = new SlimefunItemStack(
            "ANGEL_TALISMAN", Material.EMERALD, "&aAngel Talisman", "", "&fWhen this talisman is in your inventory", "&fyou have a 75% chance to reduce fall damage");
    public static final SlimefunItemStack TALISMAN_FIRE = new SlimefunItemStack(
            "FIRE_TALISMAN", Material.EMERALD, "&aFirefighter Talisman", "", "&fWhen this talisman is in your inventory", "&fwhen you're on fire", "&fit gives you fire resistance", "&fand will then be consumed");
    public static final SlimefunItemStack TALISMAN_MAGICIAN = new SlimefunItemStack(
            "MAGICIAN_TALISMAN", Material.EMERALD, "&aMagician Talisman", "", "&fWhen this talisman is in your inventory", "&fwhen enchanting, you have an 80% chance", "&fto get an additional enchantment");
    ...
    public static final SlimefunItemStack TALISMAN_WARRIOR = new SlimefunItemStack(
            "WARRIOR_TALISMAN", Material.EMERALD, "&aWarrior Talisman", "", "&fWhen this talisman is in your inventory", "&fafter being attacked, you will gain Strength 3", "&fand will then be consumed");
    ...
    public static final SlimefunItemStack TALISMAN_WHIRLWIND = new SlimefunItemStack(
            "WHIRLWIND_TALISMAN", Material.EMERALD, "&aWhirlwind Talisman", "", "&fWhen this talisman is in your inventory", "&fyou have a 60% chance", "&fto deflect all projectiles coming at you");
    ...
    public static final SlimefunItemStack TALISMAN_CAVEMAN = new SlimefunItemStack(
            "CAVEMAN_TALISMAN", Material.EMERALD, "&aCaveman Talisman", "", "&fWhen this talisman is in your inventory", "&fwhen mining, you have a 50% chance", "&fto gain a brief Haste effect");
    public static final SlimefunItemStack TALISMAN_WISE = new SlimefunItemStack(
            "WISE_TALISMAN", Material.EMERALD, "&aWise Talisman", "", "&fWhen this talisman is in your inventory", "&fexperience gained has a 20% chance to be doubled");
    ...
    public static final SlimefunItemStack STAFF_WIND = new SlimefunItemStack(
            "STAFF_ELEMENTAL_WIND", Material.STICK, "&6Elemental Staff &7- &b&oWind", "", "&7Element: &b&oWind", "", "&7&eRight-Click&7 to launch yourself");
    ...
    public static final SlimefunItemStack STAFF_WATER = new SlimefunItemStack(
            "STAFF_ELEMENTAL_WATER", Material.STICK, "&6Elemental Staff &7- &1&oWater", "", "&7Element: &1&oWater", "", "&7&eRight-Click&7 to extinguish fire on yourself");
    ...
    public static final SlimefunItemStack GRIND_STONE =
            new SlimefunItemStack("GRIND_STONE", Material.DISPENSER, "&bGrind Stone", "", "&a&oMore efficient grinding");
    ...
    public static final SlimefunItemStack MAKESHIFT_SMELTERY = new SlimefunItemStack(
            "MAKESHIFT_SMELTERY", Material.BLAST_FURNACE, "&eMakeshift Smeltery", "", "&rA simple version of the smeltery", "&rcan only smelt ore dust into ingots");
    public static final SlimefunItemStack SMELTERY =
            new SlimefunItemStack("SMELTERY", Material.FURNACE, "&6Smeltery", "", "&aHigh-temperature furnace capable of smelting metals");
    public static final SlimefunItemStack IGNITION_CHAMBER = new SlimefunItemStack(
            "IGNITION_CHAMBER", Material.DROPPER, "&4Ignition Chamber", "&rTo prevent your smeltery from losing flame", "&rplace flint inside", "&rthen place next to the smeltery's dispenser");
    public static final SlimefunItemStack ORE_CRUSHER =
            new SlimefunItemStack("ORE_CRUSHER", Material.DISPENSER, "&bOre Crusher", "", "&a&oCrushes ores and gives double ore dust");
    ...
    public static final SlimefunItemStack ORE_WASHER =
            new SlimefunItemStack("ORE_WASHER", Material.CAULDRON, "&6Ore Washer", "", "&a&oWashes sifted ore into filtered ore", "&a&oand gives you some small stone chunks");
    ...
    public static final SlimefunItemStack ENHANCED_CRAFTING_TABLE = new SlimefunItemStack(
            "ENHANCED_CRAFTING_TABLE", Material.CRAFTING_TABLE, "&eEnhanced Crafting Table", "", "&a&oA primitive crafting table", "&a&ocannot withstand powerful forces...");
    public static final SlimefunItemStack CRUCIBLE =
            new SlimefunItemStack("CRUCIBLE", Material.CAULDRON, "&cCrucible", "", "&a&oUsed to turn items into liquids");
    public static final SlimefunItemStack JUICER =
            new SlimefunItemStack("JUICER", Material.GLASS_BOTTLE, "&aJuicer", "", "&aAllows you to create delicious juices");
    ...
    public static final SlimefunItemStack SOLAR_PANEL =
            new SlimefunItemStack("SOLAR_PANEL", Material.DAYLIGHT_DETECTOR, "&bSolar Panel", "", "&7Important component for crafting &bSolar Generators");
    ...
    public static final SlimefunItemStack OUTPUT_CHEST = new SlimefunItemStack(
            "OUTPUT_CHEST", Material.CHEST, "&4Output Chest", "", "&c&oPlace it next to a basic machine's dispenser", "&c&oand crafted items will be placed in the chest");
    ...
    public static final SlimefunItemStack ENHANCED_FURNACE = new SlimefunItemStack(
            "ENHANCED_FURNACE", Material.FURNACE, "&7Enhanced Furnace - &eI", "", "&7Smelting Speed: &e1x", "&7Fuel Efficiency: &e1x", "&7Output Multiplier: &e1x");
    ...
    public static final SlimefunItemStack REINFORCED_FURNACE = new SlimefunItemStack(
            "REINFORCED_FURNACE", Material.FURNACE, "&7Reinforced Alloy Furnace", "", "&7Smelting Speed: &e10x", "&7Fuel Efficiency: &e10x", "&7Output Multiplier: &e3x");
    ...
    public static final SlimefunItemStack BLOCK_PLACER =
            new SlimefunItemStack("BLOCK_PLACER", Material.DISPENSER, "&aBlock Placer", "", "&rAll blocks in this dispenser", "&rwill be automatically placed");
    ...
    public static final SlimefunItemStack GPS_MARKER_TOOL = new SlimefunItemStack(
            "GPS_MARKER_TOOL", Material.REDSTONE_TORCH, "&bGPS Marker Tool", "", "&rAllows you to set a waypoint", "&rat the location where you place this marker tool");
    ...
    public static final SlimefunItemStack GPS_GEO_SCANNER = new SlimefunItemStack(
            "GPS_GEO_SCANNER", HeadTexture.GEO_SCANNER, "&bGPS Geo Scanner", "", "&rScans a chunk to see how many natural resources", "&rit contains, such as &8Crude Oil");
    public static final SlimefunItemStack PORTABLE_GEO_SCANNER = new SlimefunItemStack(
            "PORTABLE_GEO_SCANNER", Material.CLOCK, "&bPortable Geo Scanner", "", "&rScans for natural resources in a chunk", "", "&eRight-Click&7 to scan");
    ...
    public static final SlimefunItemStack OIL_PUMP = new SlimefunItemStack(
            "OIL_PUMP", HeadTexture.OIL_PUMP, "&rOil Pump", "", "&7Pumps crude oil and fills buckets", "", "&c&l! &cPlease perform a geo scan on the chunk first");
    ...
    public static final SlimefunItemStack INFUSED_HOPPER =
            new SlimefunItemStack("INFUSED_HOPPER", Material.HOPPER, "&5Infused Hopper", "", "&rAutomatically sucks in all items", "&rin a 7x7x7 area around the hopper");
    ...
    public static final SlimefunItemStack CARGO_MANAGER =
            new SlimefunItemStack("CARGO_MANAGER", HeadTexture.CARGO_MANAGER, "&6Cargo Manager", "", "&rCore component of the item transport network");
    public static final SlimefunItemStack CARGO_CONNECTOR_NODE =
            new SlimefunItemStack("CARGO_NODE", HeadTexture.CARGO_CONNECTOR_NODE, "&7Cargo Node &c(Connector)", "", "&rCargo connection pipe");
    ...
    public static final SlimefunItemStack TRASH_CAN =
            new SlimefunItemStack("TRASH_CAN_BLOCK", HeadTexture.TRASH_CAN, "&3Trash Can", "", "&rYou can place unwanted items here");
    ...
    public static final SlimefunItemStack MAGNESIUM_SALT =
            new SlimefunItemStack("MAGNESIUM_SALT", Material.SUGAR, "&cMagnesium Salt", "", "&7is a special fuel that can be used in Magnesium Generators");
    ...
    public static final SlimefunItemStack CRAFTER_SMART_PORT = new SlimefunItemStack(
            "CRAFTER_SMART_PORT", Material.LIME_STAINED_GLASS, "&aCrafter Smart Port", "", "&5Can distribute input quantities based on recipe material amounts", "&5and has designated output slots");
