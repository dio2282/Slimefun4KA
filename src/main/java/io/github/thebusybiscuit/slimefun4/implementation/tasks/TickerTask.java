    ...
    private void reportErrors(Location l, SlimefunItem item, Throwable x) {
        ...
        if (errors == 1) {
            ...
            Slimefun.logger()
                    .log(
                            Level.SEVERE,
                            "Multiple errors occurred in the past 4 ticks, the machine corresponding to this block has been disabled.");
            Slimefun.logger()
                    .log(
                            Level.SEVERE,
            ...
            Slimefun.logger()
                    .log(
                            Level.SEVERE,
                            "If you want to report an error, please send the error report file mentioned above to others, not a screenshot of this window");
