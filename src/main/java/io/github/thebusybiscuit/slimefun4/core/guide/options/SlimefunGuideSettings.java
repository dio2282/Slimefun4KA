    ...
    private static void addHeader(Player p, ChestMenu menu, ItemStack guide) {
        ...
        menu.addItem(
                ...
                new CustomItemStack(
                        ...
                        "",
                        "&fTranslated By StarWishsama",
                        "&cPlease do not screenshot this version information to Discord/Github to report bugs",
                        "&cInstead, please report to the translation page first",
                        "",
        ...
        menu.addItem(
                ...
                new CustomItemStack(
                        ...
                        "&7&oSource code can be found on GitHub",
                        "&7&oIf you want this project to continue",
                        "&7&oyou can consider contributing to the project",
                        "",
                        "&7\u21E8 &eClick to go to Chinese Edition GitHub repository"));
        // @formatter:on
        ...
        menu.addItem(
                ...
                new CustomItemStack(
                        ...
                        "",
                        "&7Slimefun is a large project, but addons",
