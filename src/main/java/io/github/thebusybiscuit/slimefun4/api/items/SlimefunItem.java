...
public class SlimefunItem implements Placeable {
     ...
     *
     * Returns the unofficial Chinese Wiki URL
     ...
     *
     * @param page The wiki page for the item
     */
    public final void addWikiPage(@Nonnull String page) {
        Validate.notNull(page, "Wiki page cannot be null.");

        if (addon == null) {
            Slimefun.logger().warning("This item \"" + getId() + "\" is not registered yet, please add the wiki page after the item is registered");
            return;
        }
