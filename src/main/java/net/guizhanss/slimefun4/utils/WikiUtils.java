...
public final class WikiUtils {
     ...
     *
     * @param addon The addon {@link SlimefunAddon} instance
     */
    ...
    /**
     * Reads the addon's wiki.json and sets the Wiki button for items
     * Can modify the page URL
     *
     * @param plugin The addon {@link SlimefunAddon} instance
     * @param formatter Function to modify the page URL
     */
