...
class EnvironmentChecker {
    ...
    static boolean checkIncompatiblePlugins(@Nonnull Logger logger) {
        ...
        logger.log(Level.WARNING, "These plugins appear here because they are incompatible with the current");
        ...
        logger.log(Level.WARNING, "please contact us to modify.");
        logger.log(Level.WARNING, "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
        logger.log(Level.WARNING, "");
        printBorder(logger);
                ...
                .runTaskLater(
                        ...
                        () -> {
                            if (Bukkit.getPluginManager().getPlugin("SlimeGlue") == null) {
                                sf.getLogger().log(Level.WARNING, "SlimeGlue is not installed, you will miss additional protection checks for some plugins!");
